...
function HomePage() {
  ...
  const projectsParallax = useTransform(projectsScrollYProgress, [0, 1], 
    isMobile ? [-200, 100] : [-250, 300]);
  const contactParallax = useTransform(contactScrollYProgress, [0, 1], isMobile ? [-50 , 50] : [-50, 100]);
  ...
  return (
      <main id='home' className='h-screen w-screen'>
          ...
          <section className='h-2/3 md:h-[75%] bg-[#404C51] flex flex-col justify-center overflow-hidden'>
          ...
          <section id='services' className='h-fit bg-slate-100 relative z-1 pb-[150px]'>
          <div className='h-full w-full bg-[url("./topography.svg")] bg-cover  opacity-5 absolute z-[0]'/>
              <p className='w-[80%] md:w-[60%] mx-auto flex justify-end text-black text-6xl md:text-[100px] lg:text-[200px] py-[100px]'>SERVICES</p>
          ...
          <section ref={projectsContainer} id='projects' className=' bg-white'>
            <div className="overflow-hidden h-fit">
              <motion.p style={{y: projectsParallax}} className='w-[60%] mx-auto text-black text-[300px] ml-[10%] hidden md:block'>WORK</motion.p>
              <motion.p style={{y: projectsParallax}} className='w-[60%] mx-auto text-black text-[100px] ml-[10%] block md:hidden'>WORK</motion.p>
            </div>
              <WorkScroll />
          </section>

          <section ref={contactContainer}  id='contact' className='md:h-full bg-white relative z-0'> 
          <div className='h-[110vh] md:h-[100vh] w-full bg-[url("./clouds.svg")]  opacity-5 absolute z-[0]'/>
            <div className="overflow-hidden">
              <motion.p
            ...
            <div className="h-full w-[90%] md:w-[80%] xl:w-[60%] block md:flex justify-between mx-auto my-12">
              <MeCard />
              <div className="h-[67%] w-[90%] md:w-1/2 z-10 text-black flex flex-col items-end gap-y-10 my-12 md:my-0">
                ...
                <p className='w-[90%] font-[Oswald] font-light text-xl md:text-2xl'>Hit 'Become a Client' and let's embark on a creative journey together. At Guillaume Dev, your vision meets innovation. Get a website that's not only beautiful but also boosts your business. Let's make digital waves.</p>
                <BookButton />
              </div>
            </div>
          </section>
